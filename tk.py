...
# importing and adding paths for images

photoOne = PhotoImage(file = r"C:\Users\hturn\Downloads\breezypythongui\image1.png")
...
button1 = tk.Button(root, text="Button 1", image = photoOne).pack(side="top")
