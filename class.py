...
#NOTE: 
# This programm is purley to demonstraight the formattinging of a proper module. It will not run. I tried debugging it and could not figure out what was worng with it. 
